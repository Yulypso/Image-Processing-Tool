...
def test_all(input_file_name, verbose):
    printProgressBar(0, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test Rotation 90 #
    ...
    printProgressBar(1, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test Rotation 180 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    ...
    printProgressBar(2, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test Rotation 270 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    ...
    printProgressBar(3, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(4, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(5, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(6, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(7, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(8, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(9, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test contrast adjustment +80 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.contrast_image(+80)
    ...
    printProgressBar(10, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test contrast adjustment +180 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.contrast_image(+180)
    ...
    printProgressBar(11, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test contrast adjustment +255 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.contrast_image(+255)
    ...
    printProgressBar(12, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(13, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(14, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(15, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test brightness adjustment +80 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.brightness_image(+80)
    ...
    printProgressBar(16, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test brightness adjustment +180 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.brightness_image(+180)
    ...
    printProgressBar(17, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test brightness adjustment +255 #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.brightness_image(+255)
    ...
    printProgressBar(18, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test grayscale mean #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    ...
    printProgressBar(19, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(20, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(21, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test flip #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    pandaBmp.flip_image()
    ...
    printProgressBar(22, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(23, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(24, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(25, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(26, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(27, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(28, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test negative image #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    ...
    printProgressBar(29, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(30, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(31, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(32, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(33, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test emboss filter #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
    ...
    printProgressBar(34, 35, prefix='Progress:', suffix='Complete', length=50)
    ...
    printProgressBar(35, 35, prefix='Progress:', suffix='Complete', length=50)
    # Test blur filter #
    pandaBmp = BmpProcessing.BmpProcessing(input_file_name, verbose)
    pandaBmp.fit(True)
